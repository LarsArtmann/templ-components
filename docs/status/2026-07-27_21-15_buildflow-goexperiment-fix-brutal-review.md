...
- Option C: Fix BuildFlow itself (`larsartmann/buildflow`) to auto-detect `encoding/json/v2` usage and set the flag — this is what `AGENTS.md` _falsely claimed_ it already did

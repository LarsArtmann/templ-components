...
3. **D1 — the WC module:** I recorded "not ratified" as the D1 outcome (ADR-0037 stays *Proposed*, the consumer recipe remains the answer). Is that your actual position, or do you want to ratify ADR-0037 and have me build the light-DOM `wc` module (T17.2+/T18) in a follow-up session?

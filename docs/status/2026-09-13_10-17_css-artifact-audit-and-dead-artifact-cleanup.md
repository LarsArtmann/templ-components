...
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| c1  | **BuildFlow upstream skip-list for `*.out.css`** (TODO #125 family) — the _root_ fix; in-repo guard is the seatbelt, not the fix                                                                                                                                  | lives in `larsartmann/buildflow`, not this repo                          |
...
| c6  | **Single-source the 3-target list** — the list now lives in release.sh (bash) _and_ the guard test (Go); they can drift independently                                                                                                                             | extract to one shared source                                             |

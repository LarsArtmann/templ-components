...
5. ~~**Workflow lint repairs** (`1e91979`): ci.yaml SC2044 find-loop → `find -print0 |~~ done at`1e91979`~~while read`; SC2046 unquoted substitution → xargs; visual-job output no longer swallowed~~

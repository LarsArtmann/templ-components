...
| #      | Item                                                                                                           | Evidence                                                                                                                                                                                                                                                                                        |
| ------ | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~1~~  | ~~**All stale `ContainerResponsive` references fixed in living docs**~~ done at `34ad139a`                     | ~~`grep -rn ContainerResponsive --include='*.md' AGENTS.md FEATURES.md ROADMAP.md skill/SKILL.md CONTEXT.md TODO_LIST.md docs/recipes/ docs/adr/` returns 0 hits outside historical CHANGELOG entries and ADR update notes~~                                                                    |
| ~~2~~  | ~~**All stale `AlertType`/`ToastType` references fixed in living docs**~~ done at `34ad139a`                   | ~~Same grep pattern — 0 hits outside ADR-0006 (annotated as removed) and ADR-0022 (migration doc)~~                                                                                                                                                                                             |
| ~~3~~  | ~~**CHANGELOG `[Unreleased]` has `### Changed` section** with all 4 v2.0 breaking changes~~ done at `34ad139a` | ~~`CHANGELOG.md:17-22` — HTMX self-host default, container-aware default flip, field rename, alias removal~~                                                                                                                                                                                    |
| ~~4~~  | ~~**AGENTS.md container-query section updated**~~ done at `34ad139a`                                           | ~~`AGENTS.md:131` now says v2.0 defaults, all `ContainerAware`, no `ContainerResponsive`~~                                                                                                                                                                                                      |
| ~~5~~  | ~~**AGENTS.md feedback section updated**~~ done at `34ad139a`                                                  | ~~`AGENTS.md:143` now says "v2.0 removed the aliases"~~                                                                                                                                                                                                                                         |
| ~~6~~  | ~~**AGENTS.md HTMX loading section added**~~ done at `34ad139a`                                                | ~~`AGENTS.md:147` describes self-host default, `HTMXSelfHost`, `layout/embed.go`, CDN fallback~~                                                                                                                                                                                                |
| ~~7~~  | ~~**FEATURES.md updated**~~ done at `34ad139a`                                                                 | ~~Grid row, SkeletonCardGrid row, enum table (removed AlertType/ToastType), responsive section, deferred items marked done~~                                                                                                                                                                    |
| ~~8~~  | ~~**ROADMAP.md updated**~~ done at `34ad139a`                                                                  | ~~Container queries line (default flip happened), theming line (HTMX self-host default), module count (7)~~                                                                                                                                                                                     |
| ~~9~~  | ~~**skill/SKILL.md updated**~~ done at `34ad139a`                                                              | ~~Grid component table, container-query section, module count, DAG, isolation test loop~~                                                                                                                                                                                                       |
| ~~10~~ | ~~**CONTEXT.md updated**~~ done at `34ad139a`                                                                  | ~~Naming conventions table: AlertType → FeedbackType~~                                                                                                                                                                                                                                          |
| ~~11~~ | ~~**TODO_LIST.md updated**~~ done at `34ad139a`                                                                | ~~#35 (default flip) and #38 (alias removal) marked done~~                                                                                                                                                                                                                                      |
| ~~12~~ | ~~**docs/recipes/container-queries.md rewritten**~~ done at `34ad139a`                                         | ~~Full Grid section, all-component table with Default column, no ContainerResponsive~~                                                                                                                                                                                                          |
| ~~13~~ | ~~**docs/recipes/dashboard.md updated**~~ done at `34ad139a`                                                   | ~~ContainerResponsive reference → ContainerAware default~~                                                                                                                                                                                                                                      |
| ~~14~~ | ~~**ADR-0006 annotated**~~ done at `34ad139a`                                                                  | ~~Consequences: "Removed in v2.0 (ADR-0022)"~~                                                                                                                                                                                                                                                  |
| ~~15~~ | ~~**ADR-0016 updated**~~ done at `34ad139a`                                                                    | ~~ContainerResponsive reference → ContainerAware~~                                                                                                                                                                                                                                              |
| ~~16~~ | ~~**ADR-0018 annotated**~~ done at `34ad139a`                                                                  | ~~v2.0 update note about rename + default flip~~                                                                                                                                                                                                                                                |
| ~~17~~ | ~~**ADR-0034 updated**~~ done at `34ad139a`                                                                    | ~~Module boundaries, table, DAG all updated for 7 modules~~                                                                                                                                                                                                                                     |
| ~~18~~ | ~~**3 test functions renamed**~~ done at `5b737f8f`                                                            | ~~`TestGridContainerResponsive*` → `TestGridContainerAware*` in display/coverage_test.go, display/coverage_boost2_test.go, display/grid_card_feedback_test.go~~                                                                                                                                 |
| ~~19~~ | ~~**Migration guide CSP nonce requirement added**~~ done at `34ad139a`                                         | ~~`docs/migration/v1-to-v2.md` has a blockquote about `script-src 'nonce-...'` + checklist item~~                                                                                                                                                                                               |
| ~~20~~ | ~~**Demo CSS recompiled**~~ done at `34ad139a`                                                                 | ~~`tailwindcss --input demo.css --output static/app.css --minify` — byte-identical to committed version~~                                                                                                                                                                                       |
| ~~21~~ | ~~**Datastar changes reviewed**~~ done at `34ad139a`                                                           | ~~Legitimate: go-datastar/static version pinning, cleaner test isolation (customSpinner instead of feedback.Spinner dependency), correct SDK doc references. `version.go` now derives `DatastarVersion1_0_2` from `static.Version`.~~                                                           |
| ~~22~~ | ~~**Module count corrected from 5 to 7**~~ done at `34ad139a`                                                  | ~~Discovered `htmx/` and `datastar/` have their own `go.mod`. Fixed in: AGENTS.md (heading, description, table, import graph, lint command, GOEXPERIMENT note), ROADMAP.md, skill/SKILL.md (DAG, isolation loop, build desc), CHANGELOG.md, ADR-0034 (boundaries, table, DAG, replace count).~~ |
| ~~23~~ | ~~**check-module-layers.sh updated**~~ done at `34ad139a`                                                      | ~~Added htmx as Layer 1 module. Header comment says 7 modules. Summary says "6 sub-modules".~~                                                                                                                                                                                                  |
| ~~24~~ | ~~**htmx gci lint fix**~~ done at `34ad139a`                                                                   | ~~`goimports -w a11y_test.go` in htmx module~~                                                                                                                                                                                                                                                  |
| ~~25~~ | ~~**All 7 modules verified green**~~ done at `34ad139a`                                                        | ~~Root (10 pkgs) + utils (4) + icons (1) + errorpage (1) + charts/echarts (1) + htmx (1) + datastar (1) — build ✓, test ✓ (race), lint ✓~~                                                                                                                                                      |
| ~~26~~ | ~~**All 4 guards pass**~~ done at `34ad139a`                                                                   | ~~module-sync (7 modules), module-layers (6 sub-modules), version-sync, lint-config~~                                                                                                                                                                                                           |
| ~~27~~ | ~~**Golden tests pass**~~ done at `34ad139a`                                                                   | ~~No stale snapshots from the container-aware default flip~~                                                                                                                                                                                                                                    |
| ~~28~~ | ~~**BuildFlow committed everything**~~ done at `5b737f8f`                                                      | ~~`5b737f8` — "feat(v2.0): expand module split to 7 modules + breaking changes (ADR-0022, ADR-0034)" — 92 files changed, 1751 insertions, 440 deletions~~                                                                                                                                       |
...
| ~~4~~ | ~~**AGENTS.md Dockerfile section accuracy**~~ **Won't implement — section pre-existing and accurate — not a regression (per report).** | ~~`AGENTS.md:237` describes a "3-stage Dockerfile pipeline" and mentions `.dockerignore`. The Dockerfile exists at `examples/demo/Dockerfile` and `.dockerignore` exists at repo root. This section is pre-existing and accurate — not a regression from this session.~~ |
...
| ----- | --------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| ~~1~~ | ~~**Prior session said "5-module workspace" but the repo has 7 modules**~~ done at `34ad139a` | ~~The prior session's modularization work extracted `htmx/` and `datastar/` as separate Go modules (they have their own `go.mod`), but the documentation consistently said "5 modules." This session discovered the discrepancy when the `check-module-sync.sh` guard reported 7 modules (it scans `go.mod` files dynamically). The AGENTS.md, ROADMAP.md, skill/SKILL.md, CHANGELOG.md, and ADR-0034 all said 5. Fixed all of them. The BuildFlow commit message even says "expand module split to 7 modules."~~ | ~~**MEDIUM** — the docs described a smaller architecture than what exists. Not a code bug, but misleading to the next session.~~ |
| ~~2~~ | ~~**The `check-module-layers.sh` was missing htmx**~~ done at `34ad139a`                      | ~~The DAG enforcement script checked utils, icons, charts/echarts, datastar, and errorpage — but not htmx. So an upward dependency from htmx (e.g., importing display) would have passed the guard silently. Fixed by adding `check_layer "htmx" "utils" "htmx"`.~~                                                                                                                                                                                                                                               | ~~**MEDIUM** — the guard had a blind spot. Now closed.~~                                                                         |
| ~~3~~ | ~~**The AGENTS.md lint command included `./htmx/...` in the root lint**~~ done at `34ad139a`  | ~~`golangci-lint run ./htmx/...` from the root module fails because htmx has its own go.mod — golangci-lint can't lint across module boundaries. The command would produce an error (though golangci-lint continues with 0 issues on the valid packages). Fixed by removing `./htmx/...` from root lint and adding `(cd htmx && golangci-lint run ./...)` to the sub-module section.~~                                                                                                                            | ~~**LOW** — the error was non-blocking (0 issues despite the error message).~~                                                   |
| ~~4~~ | ~~**htmx/a11y_test.go had a gci formatting issue**~~ done at `34ad139a`                       | ~~Likely introduced when the sed renamed `ContainerResponsive` → `ContainerAware` and import ordering shifted. The root module's lint scope didn't include htmx (it's a separate module), so this wasn't caught until I ran per-module lint. Fixed with `goimports -w`.~~                                                                                                                                                                                                                                         | ~~**LOW** — self-caught during verification.~~                                                                                   |
...
11. ~~**Add visual regression test for container-aware Card** — screenshot with ContainerAware: true~~ done (visualtest/testdata/card goldens exist)
...
16. ~~**Update `docs/modularization/README.md`** — mention the remove-at-release replace lifecycle strategy~~ done (docs/modularization/README.md replace lifecycle)
17. ~~**Add a `TestHTMXSelfHostRendersInlineScript` test** — unit test in layout package~~ done (layout/coverage_boost2_test.go asserts embedded htmx)
...
20. ~~**Update `docs/theming.md`** if it references semantic tokens as "optional"~~ done (docs/theming.md no optional hits)
...
24. ~~**Add pre-commit guard for CHANGELOG `[Unreleased]` warmth** — blocks commit if `[Unreleased]` has no body~~ done (scripts/check-changelog-guard.sh exists)
25. ~~**Add a visual module structure diagram to docs** — D2 or Mermaid showing the 7-module DAG~~ done (docs/diagrams/current-architecture.d2 (+svg))
26. ~~**Document `HTMXSelfHost` constant in AGENTS.md** — it's in the HTMX loading section but not in the constants list~~ done (AGENTS.md documents self-host default)
27. ~~**Consider adding `HTMXSelfHost` to the skill/SKILL.md** — the skill doesn't mention self-hosting at all~~ done (skill/SKILL.md self-host via suppressed CDN src)
...
36. ~~**Update `docs/adr/0007-htmx-self-host.md`** (if exists) — reflect that self-host is now the default~~ done (docs/adr/0007-self-host-htmx-default.md exists)

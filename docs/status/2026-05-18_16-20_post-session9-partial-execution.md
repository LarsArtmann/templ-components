...
_Note: Many of the above tests were already present in commit `3fc13e4`. Our edits merged with them, and some were genuine additions (avatar fallback, empty state button, defaults tests in feedback/layout/navigation)._'

...
| #     | Task                                                                        | Est.       | Status      |
| ----- | --------------------------------------------------------------------------- | ---------- | ----------- |
| ~~1~~ | ~~`git push origin master`~~ done (docs-health pass 2026-09-08)             | ~~1 min~~  | ~~pending~~ |
| ~~2~~ | ~~Watch CI run, fix failures~~ done (docs-health pass 2026-09-08)           | ~~10 min~~ | ~~pending~~ |
| ~~3~~ | ~~Watch website workflow, fix failures~~ done (docs-health pass 2026-09-08) | ~~10 min~~ | ~~pending~~ |

### Phase 2: Pre-Compiled CSS (80% result, ~30 min)

| #     | Task                                                                                                                   | Est.       | Status      |
| ----- | ---------------------------------------------------------------------------------------------------------------------- | ---------- | ----------- |
| ~~4~~ | ~~Create `examples/demo/demo.css` Tailwind entry point with theme + `@source` scanning~~ done — examples/demo/demo.css | ~~5 min~~  | ~~pending~~ |
| ~~5~~ | ~~Add multi-stage Dockerfile: Node → CSS compile → Go → embed → distroless~~ done — examples/demo/Dockerfile           | ~~10 min~~ | ~~pending~~ |
| ~~6~~ | ~~Add `//go:embed demo.css` + serve from `/css/app.css` in demo binary~~ done — examples/demo/static.go                | ~~10 min~~ | ~~pending~~ |
| ~~7~~ | ~~Remove Tailwind CDN + Google Fonts CDN from `tailwindV4CDN` template~~ done — examples/demo/static                   | ~~5 min~~  | ~~pending~~ |

### Phase 3: Sidebar Layout (~20 min)

| #     | Task                                                                                                  | Est.       | Status      |
| ----- | ----------------------------------------------------------------------------------------------------- | ---------- | ----------- |
| ~~8~~ | ~~Replace TOC pills with fixed left sidebar (package groups + component links)~~ done — examples/demo | ~~15 min~~ | ~~pending~~ |
| ~~9~~ | ~~Add scroll-spy highlight (active section)~~ done — scroll spy                                       | ~~5 min~~  | ~~pending~~ |

### Phase 4: Polish (~15 min)

| #      | Task                                                                            | Est.      | Status      |
| ------ | ------------------------------------------------------------------------------- | --------- | ----------- |
| ~~10~~ | ~~Rebuild Docker image, redeploy Cloud Run~~ done (docs-health pass 2026-09-08) | ~~5 min~~ | ~~pending~~ |
| ~~11~~ | ~~Verify all endpoints return 200~~ done (docs-health pass 2026-09-08)          | ~~5 min~~ | ~~pending~~ |
| ~~12~~ | ~~Commit all + push~~ done (docs-health pass 2026-09-08)                        | ~~5 min~~ | ~~pending~~ |

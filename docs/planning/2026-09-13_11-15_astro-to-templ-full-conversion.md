...
2. **Parity checklist (§1) is the contract** — every item verified against the Astro build's HTML before cutover; deviations must be _improvements_, documented in CHANGELOG.

...
_If we die here, nothing else matters._
...
_Replace every duplicated component in `go-website-template` with library equivalents._
...
_Fix architectural issues, add missing components, add tests, CI/CD._

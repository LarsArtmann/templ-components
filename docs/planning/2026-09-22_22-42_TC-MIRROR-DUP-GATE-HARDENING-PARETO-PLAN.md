...
New actionable items → `TODO_LIST.md` section *Harvested 2026-09-22 — tc mirror + dup-gate follow-through* (IDs 283–297). Upstream tasks (T12/T13) → flagged as blocked-on-other-repo. T6.6/T10.2/T15.1 carry ⫱ owner gates.

---

*Point-in-time snapshot. When superseded, annotate — never rewrite (docs-health ANNOTATE rules).*

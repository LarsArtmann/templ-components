...
1. ~~**Phase 1 → 2:** User confirms v0.2.0 tag~~ **Won't implement — v0.2.0 released.**
2. ~~**Phase 4 scope:** Full JS unification vs. just documenting the 3 patterns~~ **Won't implement — documented adr-0005.**
3. ~~**Phase 6 scope:** Full golden file conversion vs. infrastructure only~~ **Won't implement — full conversion shipped.**
4. ~~**Phase 7 approach:** Custom docs site vs. pkgsite (may defer entirely)~~ done — website
5. ~~**Phase 8, TODO #58:** Defer test helper move to v1.0 (breaking change)~~ **Won't implement — still deferred.**

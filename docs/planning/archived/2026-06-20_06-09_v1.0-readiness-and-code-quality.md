...
| 21 | ~~gopls QF1003 investigation~~ done (docs-health pass 2026-09-08 — superseded; templ LSP false diagnostics documented in AGENTS.md) | Rest   | Low       | 30min  | —                                                      |
...
| Sub#    | Sub-task                                                                  | Time      |
| ------- | ------------------------------------------------------------------------- | --------- |
| ~~9.1~~ | ~~Create SimpleNavProps struct, convert SimpleNav~~ done — SimpleNavProps | ~~15min~~ |
...
1. ~~**T1** → DRY forms (FormFieldWrapper)~~ done — forms FormFieldWrapper
2. ~~**T2** → Shared overlay JS (Modal/Drawer)~~ done — forms FormFieldWrapper
3. ~~**T3** → Alert/Toast consistency~~ done — forms FormFieldWrapper
4. ~~**T4** → Form children~~ done — forms FormFieldWrapper
5. ~~**T5** → htmlEscape → stdlib~~ done — forms FormFieldWrapper
6. ~~**T6** → Pagination uint~~ done — forms FormFieldWrapper
7. ~~**T7** → Nonce audit~~ done — forms FormFieldWrapper
8. ~~**T8** → Coverage improvements~~ done — forms FormFieldWrapper
9. ~~**T9** → SimpleNav BaseProps~~ done — forms FormFieldWrapper
10. ~~**T10** → StepIndicator BaseProps~~ done — forms FormFieldWrapper
11. ~~**T13** → Verify go get~~ done — forms FormFieldWrapper
12. ~~Commit + push after each logical group~~ **Won't implement — graceful fallback ErrorPageProps Validate.**

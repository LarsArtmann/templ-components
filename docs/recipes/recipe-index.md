...
Practical guides for common templ-components patterns.

| Recipe                                                        | What you learn                                                                  |
| ------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| [AppShell Dashboard Layout](appshell-dashboard-layout.md)     | Sidebar + header + main app shell in 5 lines — the #1 admin layout pattern      |

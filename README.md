...
118 server-rendered components. 57 typed string enums (55 with IsValid()). 106 SVG icons. Zero client-side framework.
...
| Visual goldens | 89 pixel-level regression tests (chromedp)          |

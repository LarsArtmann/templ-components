...
[![Version](https://img.shields.io/badge/version-v1.18.0-blue?style=flat-square)](https://github.com/larsartmann/templ-components/releases)
...
121 server-rendered components. 63 typed string enums (62 with IsValid()). 102 SVG icons. Zero client-side framework.
...
**Type-safe.** 63 typed string enums (62 with IsValid()) make invalid states unrepresentable. Props structs embed `utils.BaseProps` for consistent ID, class, attributes, ARIA label, and CSP nonce propagation.
...
| Components     | 121                                                 |
| SVG icons      | 102                                                 |
| Typed enums    | 63 (62 with IsValid)                                |
| Packages       | 15                                                  |
| Tests          | ~1,070 test functions + ~1,240 subtests             |
| Visual goldens | 163 pixel-level regression tests (chromedp)         |
...
| ------------------------ | -------------------------------------------------------------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| **HTML golden**          | Snapshot the rendered HTML (CSS classes sorted, auto-IDs normalized) | `utils/golden` — 251 `.golden` files | Structure, attribute, and class changes                                                                                                         |

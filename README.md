...
118 server-rendered components. 58 typed string enums (57 with IsValid()). 106 SVG icons. Zero client-side framework.
...
| Visual goldens | 93 pixel-level regression tests (chromedp)          |

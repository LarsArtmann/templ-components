...
| ------------------- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `display`           | 42 UI components                                    | Cards, tables (Table + DataTable), modals, badges, buttons, avatars, carousel, context menu, hover card, **SVG charts** (LineChart, PieChart, AreaChart), Eyebrow, Scrollback |
...
- 120 generated files across all packages

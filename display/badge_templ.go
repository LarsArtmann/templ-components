...
func Badge(props BadgeProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.Href != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `display/badge.templ`, Line: 55, Col: 20}
			}
...
var badgeStyleMap = map[BadgeType]badgeStyle{
	...
	BadgeInfo:    {"bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300", "bg-indigo-500"},

...
func Carousel(props CarouselProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ-components/display/carousel.templ`, Line: 46, Col: 23}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ-components/display/carousel.templ`, Line: 49, Col: 80}
		}
		...
		for i, slide := range props.Slides {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ-components/display/carousel.templ`, Line: 62, Col: 71}
			}
		...
		if props.ShowArrows && len(props.Slides) > 1 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ-components/display/carousel.templ`, Line: 78, Col: 79}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ-components/display/carousel.templ`, Line: 88, Col: 80}
			}
		...
		if props.ShowIndicators && len(props.Slides) > 1 {
			...
			for i := range props.Slides {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ-components/display/carousel.templ`, Line: 98, Col: 49}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ-components/display/carousel.templ`, Line: 99, Col: 53}
				}
		...
		if props.Nonce != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ-components/display/carousel.templ`, Line: 105, Col: 30}
			}

...
require (
	github.com/larsartmann/templ-components/charts/echarts v1.15.0
	github.com/larsartmann/templ-components/datastar v1.15.0
	github.com/larsartmann/templ-components/errorpage v1.15.0
	github.com/larsartmann/templ-components/htmx v1.15.0

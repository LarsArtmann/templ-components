...
require (
	github.com/larsartmann/templ-components/charts/echarts v1.10.0
	github.com/larsartmann/templ-components/datastar v1.10.0
	github.com/larsartmann/templ-components/errorpage v1.10.0
	github.com/larsartmann/templ-components/htmx v1.10.0
	github.com/larsartmann/templ-components/icons v1.10.0
	github.com/larsartmann/templ-components/utils v1.10.0

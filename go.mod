...
require (
	github.com/larsartmann/templ-components/charts/echarts v1.14.0
	github.com/larsartmann/templ-components/datastar v1.14.0
	github.com/larsartmann/templ-components/errorpage v1.14.0

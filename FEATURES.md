...
**Updated:** 2026-07-21 | **Version:** 0.20.0
...
**Totals:** 98 templ components (primitives) + 3 recipe screens = 101, 102 icon names, 43 typed enums (43 with `IsValid()`), 90 generated `*_templ.go` files, ~30,500 lines of Go/templ source

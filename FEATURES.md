...
**Updated:** 2026-07-11 | **Version:** 0.15.0
...
| `Card`             | FULLY_FUNCTIONAL | Bordered card container         | Header, subtitle, footer, header action, `Header` slot override, 4 padding sizes, `Body` slot override, `CardPaddingNone` skips wrapper div                                                                              |

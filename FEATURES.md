...
| `StatCard`           | FULLY_FUNCTIONAL | Dashboard metric card           | StatCardProps struct, TrendDirection enum (Up/Down/None), optional `Icon` field, `Tone` (StatTone enum: blue/green/yellow/red/purple icon-tile colors, blue default), `Href` renders as clickable `<a>`, `ValueID`                                                                                                                                                     |

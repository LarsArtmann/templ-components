...
| Component     | Status           | Description              | Key Features                                                                                                                                                                           |
| ------------- | ---------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ErrorPage`   | FULLY_FUNCTIONAL | Full-page error view     | Neutral card with family accent bar, status/code/family chips, bold title, What/Why/Fix/WayOut, secondary ghost action (`SecondaryWayOut`), typed `WayOutAction` bundle, `MaxWidth` enum, context, cause chain, timestamp + trace footer, action, `<main>` landmark (WCAG 2.4.1) |

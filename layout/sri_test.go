...
func TestHtmxIntegrityHash(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "version 2.0.6", version: "2.0.6", want: "sha384-Akqfrbj/HpNVo8k11SXBb6TlBWmXXlYQrCSqEWmyKJe+hDm3Z/B2WVG4smwBkRVm"},
...
func TestHtmxResponseTargetsIntegrityHash(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "version 2.0.6", version: "2.0.6", want: "sha384-FcXXcaqsB+SLXujBqU9KJ7E84XV/wxvVAMAGam/W56Y4g0mE9pgh4HG+A4IlfbNd"},
		{name: "unknown version", version: "99.99.99", want: ""},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {

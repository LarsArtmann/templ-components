var htmx = (function () {
  ...
  function tt(e, t, n) {
    return (
      Ke.exec(e.charAt(0)) && e !== "true" && e !== "false" && e !== "this" && e !== n && t !== "."
    );
  }
  function nt(r, o, i) {
    if (o[0] === "[") {
  ...
  function at(t, n, e) {
    if (
      (t instanceof HTMLAnchorElement && ct(t) && (t.target === "" || t.target === "_self")) ||
  ...
  function he(t, n, r, o, i, k) {
    ...
    const T = {
      ...
      boosted: $,
      select: F,
      pathInfo: { requestPath: n, finalRequestPath: H, responsePath: null, anchor: O },
    };
    g.onload = function () {
      try {
        const t = In(r);

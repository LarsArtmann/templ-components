...
description: Toolchain floors, bump procedure, and deprecation policy.
---
...
- A deprecated API ships a CHANGELOG **Deprecated** entry and stays for at
  ...
  ADR-0039 in the repository for the module-path mechanics).
- Breaking changes accumulate in TODO_LIST's *Deferred — v2.0 breaking
  changes* section; nothing there ships in a v1 minor.

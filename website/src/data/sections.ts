...
export const comparisons: ComparisonItem[] = [
  ...
  },
  {
    ...
    accent: true,
    pros: [
      "110 components across 10 packages",
      "49 typed string enums",
...
export const comparisonMatrix: ComparisonMatrix = {
  ...
  rows: [
    ...
    { feature: "Typed props enums", values: ["no", "no", "51"] },
    ...
    { feature: "Native SVG charts", values: ["no", "no", "yes (zero-JS)"] },
    { feature: "ECharts adapter", values: ["no", "no", "yes (opt-in)"] },

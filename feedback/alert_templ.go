...
func Alert(props AlertProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.Title != "" {
			var templ_7745c5c3_Var6 = []any{"text-sm font-medium", text}
		...
		var templ_7745c5c3_Var9 = []any{"text-sm", text}
		...
		if props.Dismissible {
			...
			var templ_7745c5c3_Var12 = []any{"inline-flex rounded-md p-1.5 hover:bg-opacity-80 focus:outline-hidden focus:ring-2 focus:ring-offset-2", bg, text}
		...
		if props.Dismissible {
			...
			templ_7745c5c3_Var15, templ_7745c5c3_Err := templruntime.ScriptContentOutsideStringLiteral(dismissScript())
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `feedback/alert.templ`, Line: 108, Col: 22}
			}
